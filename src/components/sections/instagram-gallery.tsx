...
const mockPosts: InstagramPost[] = [
  ...
  {
    id: '15',
    media_url: '/events/Anastasia Chemeritskaya.jpeg',
    permalink: 'https://www.instagram.com/caltechlongevity/',
    caption: 'Event with Anastasia Chemeritskaya',
    media_type: 'IMAGE',
  },
  {
    id: '16',
    media_url: '/events/Christin Glorioso.jpg',
    permalink: 'https://www.instagram.com/caltechlongevity/',
    caption: 'Event with Christin Glorioso',
    media_type: 'IMAGE',
  },
  {
    id: '17',
    media_url: '/events/jordan-shlain.jpg',
    permalink: 'https://www.instagram.com/caltechlongevity/',
    caption: 'Event with Jordan Shlain',
    media_type: 'IMAGE',
  },
  {
    id: '18',
    media_url: '/events/Matt Scholz.jpg',
    permalink: 'https://www.instagram.com/caltechlongevity/',
    caption: 'Event with Matt Scholz',
    media_type: 'IMAGE',
  },
  {
    id: '19',
    media_url: '/events/Ryan Cabeen.png',
    permalink: 'https://www.instagram.com/caltechlongevity/',
    caption: 'Event with Ryan Cabeen',
    media_type: 'IMAGE',
  },
  {
    id: '20',
    media_url: '/events/richard diaz.jpg',
    permalink: 'https://www.instagram.com/caltechlongevity/',
    caption: 'Event with Richard Diaz',
    media_type: 'IMAGE',
  },
  {
    id: '21',
    media_url: '/events/sebastian.jpeg',
    permalink: 'https://www.instagram.com/caltechlongevity/',
    caption: 'Event with Sebastian',
    media_type: 'IMAGE',
  },
  {
    id: '22',
